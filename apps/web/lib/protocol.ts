 ...
 * backend.
 */
export const TXLINE_ORACLE_PROGRAM_ID =
...
export const LIFECYCLE_STEPS: Array<{
...
}> = [
  {
    key: "create",
    label: "Create",
    detail: "House opens on-chain markets for a real TxLINE World Cup fixture.",
  },
  {
    key: "bet",
    label: "Bet",
    detail: "Anyone stakes devnet SOL into a pari-mutuel YES/NO pool.",
  },
  {
    key: "lock",
    label: "Lock",
    detail: "Betting closes at kickoff; the pool is frozen on-chain.",
  },
  {
    key: "settle",
    label: "Settle",
    detail:
      "settle_market CPIs into TxLINE's oracle and verifies a Merkle proof on-chain.",
    trust: true,
  },
  {
    key: "claim",
    label: "Claim",
    detail:
      "Winners pull their share of the pool; losers' stake is redistributed.",
  },
]
