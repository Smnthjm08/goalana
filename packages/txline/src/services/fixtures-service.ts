...
export class FixtureService {
    ...
    async getFixtureSnapshot(startEpochDay?: number, CompetitionId?: number): Promise<TxLineFixture[] | undefined> {
        try {
    ...
    async getFixtureUpdates(epochDay: number, hourOfDay: number): Promise<TxLineFixture[] | undefined> {
        try {
    ...
    async getFixtureValidation(fixtureId: number, timestamp?: number): Promise<FixtureValidation | undefined> {
        try {
    ...
    async getFixtureBatchValidation(epochDay: number, hourOfDay: number): Promise<FixtureBatchValidation | undefined> {
        try {
